...
COLORS = np.array([[0,0,255],[0,255,0]],dtype='int32')
...
def findObjects(out_put, img):
    ...
    for indice in indices:
        ...
        color_ndarray = COLORS[obj_classes.index(obj_classes[class_ids[indice]])]
...
def drawing(img,x,y,w,h,color_tuple,class_ids,indice,confidences):
    ...
    label = f'{obj_classes[class_ids[indice]].upper()} {int(confidences[indice]*100)}%'
    # get text size
    ...
    cv.putText(img, label ,(x,y-4),font,0.6, (0,0,0),thickness=1)
